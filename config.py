...
parser.add_option('--f_conv1', '--f_conv1', dest='f_conv1', default=256, type='int',
...
parser.add_option('--k_prim', '--k_prim', dest='k_prim', default=9, type='int',
                  help='filter size of the primary capsule layer (default: 9)')
parser.add_option('--s_prim', '--s_prim', dest='s_prim', default=2, type='int',
...
parser.add_option('--lp', '--load_model_path', dest='load_model_path',
                  default='/home/cougarnet.uh.edu/amobiny/Desktop/capsule_network_pytorch/save/'
                          '20191023_181535/models/25200.ckpt',
